        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductCategories_ProductGender_ProductGenderId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductSubCategoriesId = table.Column<int>(type: "int", nullable: true),
                    ProductSubCategories = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Product_ProductGender_ProductGenderId",
                        column: x => x.ProductGenderId,
                        principalTable: "ProductGender",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Product_ProductSubCategories_ProductSubCategories",
                        column: x => x.ProductSubCategories,
                        principalTable: "ProductSubCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemTotalBill = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Product_ProductSubCategories",
                table: "Product",
                column: "ProductSubCategories");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCategories_ProductGenderId",
